...
CREATE TABLE [dbo].[Conversations] (
    ...
    [StatutConversation] NVARCHAR(20) DEFAULT 'Active',
    [DateCreation] DATETIME2 DEFAULT sysdatetime(),
    [DateDernierMessage] DATETIME2,
    [NombreMessages] INT DEFAULT 0,
    CONSTRAINT [PK__Conversa__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantConversation])
);
...
CREATE TABLE [dbo].[DeclencheursNotifications] (
    ...
    [DateCreation] DATETIME2 DEFAULT sysdatetime(),
    CONSTRAINT [PK__Declench__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantDeclencheur])
);
...
CREATE TABLE [dbo].[DistancesPrecalculees] (
    ...
    CONSTRAINT [PK__Distance__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantOrigine], [IdentifiantDestination])
);
...
CREATE TABLE [dbo].[DonneesChiffrees] (
    ...
    [ChiffrePar] INT,
    CONSTRAINT [PK__DonneesCh__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantChiffrement])
);

-- CreateTable
CREATE TABLE [dbo].[JournalAudit] (
    [IdentifiantAudit] INT NOT NULL IDENTITY(1,1),
    [IdentifiantUtilisateur] INT,
    [TypeAction] NVARCHAR(50) NOT NULL,
    [TableCible] NVARCHAR(100),
    [IdentifiantEnregistrement] INT,
    ...
    CONSTRAINT [PK__JournalA__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantAudit])
);

-- CreateTable
CREATE TABLE [dbo].[LogsErreurs] (
    [IdentifiantLog] INT NOT NULL IDENTITY(1,1),
    ...
    [DateResolution] DATETIME2,
    CONSTRAINT [PK__LogsErre__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantLog])
);
...
CREATE TABLE [dbo].[SignalementsAvis] (
    ...
    [StatutTraitement] NVARCHAR(20) DEFAULT 'EnAttente',
    [DateTraitement] DATETIME2,
    [TraitePar] INT,
    [CommentairesTraitement] NVARCHAR(500),
    CONSTRAINT [PK__Signalem__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantSignalement])
);
...
CREATE TABLE [dbo].[ZonesGeographiques] (
    ...
    [DateCreation] DATETIME2 DEFAULT sysdatetime(),
    [DateMiseAJour] DATETIME2,
    CONSTRAINT [PK__ZonesGeo__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantZone])
);
...
CREATE TABLE [dbo].[A_B_Tests] (
    ...
    [StatutTest] NVARCHAR(20) DEFAULT 'Brouillon',
    ...
    [CreePar] INT,
    [DateCreation] DATETIME2 DEFAULT sysdatetime(),
    CONSTRAINT [PK__ABTests__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantTest]),
    CONSTRAINT [UQ__ABTests__F578AEFE072605E8] UNIQUE NONCLUSTERED ([CodeTest])
);
...
CREATE TABLE [dbo].[CacheRecherches] (
    ...
    CONSTRAINT [PK__CacheRec__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantCache]),
...
CREATE TABLE [dbo].[CacheStatistiques] (
    ...
    [DateFin] DATETIME2 NOT NULL,
    [DateCalcul] DATETIME2 DEFAULT sysdatetime(),
    CONSTRAINT [PK__CacheSta__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantStatCache])
);
...
CREATE TABLE [dbo].[ConfigurationBusinessRules] (
    ...
    CONSTRAINT [PK__ConfigBR__8B49E5B3F5A65B99] PRIMARY KEY CLUSTERED ([IdentifiantRegle]),
    CONSTRAINT [UQ__ConfigBR__F578AEFE072605E8] UNIQUE NONCLUSTERED ([CodeRegle])
);
